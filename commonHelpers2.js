import{i as r,g,a as P,r as H,u as L,A as p}from"./assets/header-bb30abe4.js";import{S as j,P as D}from"./assets/vendor-ab16d78c.js";function I(e){return e.map(({_id:t,name:s,img:o,category:a,price:d,size:n,popularity:i})=>`
...
<use href="${r}#icon-basket"></use>
  ...
  </svg>`,s.disabled=!1)}function mt(e,t){t.innerHTML=rt(e)}function ft(e){e.preventDefault();const t=e.target;if(console.log(t),t.closest("li")&&t.closest(".discount-product-item")){const s=t.closest("li").dataset.productId,o=y.find(a=>a._id===s);w(o).catch(a=>{console.error("Помилка при отриманні продукта за айді:",a.message)})}}function vt(e){return e.map(({_id:t,name:s,img:o,category:a,size:d,popularity:n})=>`
  ...
  </svg>`,s.disabled=!1)}function $t(e,t){t.innerHTML=vt(e)}function Pt(e){e.preventDefault();const t=e.target;if(console.log(t),t.closest("li")&&t.closest(".popular-product-item")){const s=t.closest("li").dataset.productId,o=b.find(a=>a._id===s);w(o).catch(a=>{console.error("Помилка при отриманні продукта за айді:",a.message)})}}const Lt=document.querySelector(".js-products-list"),It=new p,Et=document.getElementById("pagination");let Bt=90;const Ct={totalItems:Bt,itemsPerPage:6,visiblePages:3,page:1,centerAlign:!0,template:{prev:`<a href="#" class="tui-page-btn tui-prev"><svg class="icon-svg"><use href="${r}#icon-Nav-Button-Prev"></use></svg></a>`,firstPageLink:'<a href="#" class="tui-page-btn tui-first">{{page}}</a>',page:'<a href="#" class="tui-page-btn tui-{{type}}">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:`<a href="#" class="tui-page-btn tui-{{type}}"><svg class="tui-ico-{{type}}" width="32" height="32"><use href="${r}#icon-Nav-Button-Next"></use></svg></a>`,disabledMoveButton:`<span class="tui-page-btn tui-is-disabled tui-{{type}}"><svg class="tui-ico-{{type}}" width="32" height="32"><use href="${r}#icon-Nav-Button-Next"></use></svg></span>`,moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>',lastPageLink:'<a href="#" class="tui-page-btn tui-last">{{page}}</a>',next:'<a href="#" class="tui-page-btn tui-next"><svg class="icon-svg"><use href="next.svg#next"></use></svg></a>'}},Mt=new D(Et,Ct);Mt.on("beforeMove",async e=>{const t=e.page,s=await It.getAllProducts(t,6);x(s.results,Lt),v(),window.scrollTo({top:100,behavior:"smooth"})});const xt=new p,Tt=document.getElementById("subscriptionForm"),qt=document.querySelector(".footer-form-input");Tt.addEventListener("submit",Ft);async function Ft(e){e.preventDefault();const t=e.currentTarget.elements.email,s=qt.value;try{const o=await xt.createSubscription({email:s});t.value="";let a="Successfully subscribed!";o&&o.data&&o.data.message&&(a=o.data.message),f(a,"success")}catch(o){console.log("Error:",o);let a="This email address has already been entered.You have already subscribed to our new products. Watch for offers at the mailing address.";o.response&&o.response.data&&o.response.data.message&&(a=o.response.data.message),f(a,"warning")}e.target.reset()}
