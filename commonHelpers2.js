import{i as n,g,a as P,r as H,u as L,A as p}from"./assets/header-fc33e606.js";import{S as j,P as D}from"./assets/vendor-ab16d78c.js";function I(e){return e.map(({_id:t,name:s,img:o,category:a,price:d,size:r,popularity:i})=>`
...
</li>`).join("")}const F=document.querySelector(".js-discount-list");F.addEventListener("click",mt);const nt=new p,it=2;let lt=[],y;async function dt(){y=(await nt.getDiscountedProducts()).slice(0,it),gt(y,F),v(),lt.forEach(t=>{ut(t._id,g().some(s=>s._id===t._id))})}dt();function ut(e,t){basketButtons.forEach(s=>{s.dataset.itemId===e&&pt(s,t)})}function pt(e,t){const s=document.querySelector(".cart-button");t?(e.innerHTML=`<svg class="ico">
  <use href="${icons}#icon-check"></use>
  </svg>`,s.disabled=!0):(e.innerHTML=`<svg class="ico">
  <use href="${icons}#icon-basket"></use>
  </svg>`,s.disabled=!1)}function gt(e,t){t.innerHTML=rt(e)}function mt(e){e.preventDefault();const t=e.target;if(console.log(t),t.closest("li")&&t.closest(".discount-product-item")){const s=t.closest("li").dataset.productId,o=y.find(a=>a._id===s);w(o).catch(a=>{console.error("Помилка при отриманні продукта за айді:",a.message)})}}function ft(e){return e.map(({_id:t,name:s,img:o,category:a,size:d,popularity:r})=>`
