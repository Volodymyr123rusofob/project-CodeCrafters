import{g as u,i as n,a as I,b as y,r as j,u as C,A as g}from"./assets/footer-f5817938.js";import{P as H}from"./assets/vendor-ab16d78c.js";const z=`<svg class="cart-icon" width="18" height="18">
...
<use href="${n}#icon-basket"></use>
      ...
      `).join("")}const O=document.querySelector(".js-popular-list");O.addEventListener("click",Et);const wt=new g,St=5;let $t=[],b;$();async function Pt(){b=(await wt.getPopularProducts()).slice(0,St),Ct(b,O),f(),$t.forEach(t=>{Lt(t._id,u().some(s=>s._id===t._id))})}Pt();function Lt(e,t){basketButtons.forEach(s=>{s.dataset.itemId===e&&It(s,t)})}function It(e,t){const s=document.querySelector(".cart-button");t?(e.innerHTML=`<svg class="cart-icon-pop">
