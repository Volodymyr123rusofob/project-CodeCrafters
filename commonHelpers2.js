...
<use href="${i}#icon-basket"></use>
      ...
      `).join("")}const O=document.querySelector(".js-popular-list");O.addEventListener("click",Lt);const yt=new g,kt=5;let bt=[],b;v();async function wt(){b=(await yt.getPopularProducts()).slice(0,kt),Pt(b,O),f(),bt.forEach(t=>{$t(t._id,u().some(s=>s._id===t._id))})}wt();function $t(e,t){basketButtons.forEach(s=>{s.dataset.itemId===e&&St(s,t)})}function St(e,t){const s=document.querySelector(".cart-button");t?(e.innerHTML=`<svg class="cart-icon-pop">
