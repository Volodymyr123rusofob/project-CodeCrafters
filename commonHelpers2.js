var D=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)};var $=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)};var g=(e,t,s)=>(D(e,t,"access private method"),s);/* empty css                      */import{a as i,S as C,P as J,N as k}from"./assets/vendor-c5b37fd0.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function s(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerpolicy&&(a.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?a.credentials="include":o.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=s(o);fetch(o.href,a)}})();var l,f;class I{constructor(t){$(this,l);this.storageBasketName=t,this.initStorage()}initStorage(){this.getAllProducts()||g(this,l,f).call(this,[])}getAllProducts(){return JSON.parse(localStorage.getItem(this.storageBasketName))}addProduct(t){if(!t)return;const s=this.getAllProducts(),r=s.find(o=>o._id===t._id);r?r.amount+=1:(t.amount=1,s.push(t)),g(this,l,f).call(this,s)}removeProductById(t){const s=this.getAllProducts(),r=s.find(o=>o._id===t);if(r)r.amount>1?r.amount-=1:s.filter(o=>o._id===r._id);else return;g(this,l,f).call(this,s)}removeAllProductsById(t){g(this,l,f).call(this,this.getAllProducts().filter(s=>s._id!==t))}removeAllProducts(){g(this,l,f).call(this,[])}removeProduct(t){const r=this.getAllProducts().filter(o=>o._id!==t);g(this,l,f).call(this,r)}}l=new WeakSet,f=function(t){localStorage.setItem(this.storageBasketName,JSON.stringify(t))};const G="productsBasket",b=new I(G);function S(){return b.getAllProducts()}function x(e){b.addProduct(e)}function K(e){b.removeAllProductsById(e)}const V="productsBasket",W=e=>{try{const t=localStorage.getItem(e);return t===null?void 0:JSON.parse(t)}catch(t){console.error("Get state error: ",t.message)}},w=()=>{const e=document.querySelector("#cart-counter"),t=W(V)??[];e.textContent=`(${t.length})`};w();const m="/project-CodeCrafters/assets/symbol-defs-e77d3d30.svg";function A(e){return e.map(({_id:t,name:s,img:r,category:o,price:a,size:c,popularity:d})=>`
